...
const int NBINS_topLeptonPt = 8; const double BINS_topLeptonPt[NBINS_topLeptonPt+1] = { 0.0, 20.0, 40.0, 60.0, 80.0, 100.0, 120.0, 185.0, 250.0 };
const int NBINS_topLeptonsMass = 8; const double BINS_topLeptonsMass[NBINS_topLeptonsMass+1] = { 0.0, 30.0, 60.0, 90.0, 120.0, 160.0, 200.0, 275.0, 350.0 };
const int NBINS_fourLeptonsMass = 8; const double BINS_fourLeptonsMass[NBINS_fourLeptonsMass+1] = { 100.0, 150.0, 200.0, 250.0, 300.0, 350.0, 400.0, 550.0, 700.0 };
    ...
    is_ttz(isTtz)
{
    ...
    topLeptonPt = makeTruthHistogram("topLeptonPt", is_ttz, nVar, nSel, nSys, NBINS_topLeptonPt, BINS_topLeptonPt);
    topLeptonsMass = makeTruthHistogram("topLeptonsMass", is_ttz, nVar, nSel, nSys, NBINS_topLeptonsMass, BINS_topLeptonsMass);
    fourLeptonsMass = makeTruthHistogram("fourLeptonsMass", is_ttz, nVar, nSel, nSys, NBINS_fourLeptonsMass, BINS_fourLeptonsMass);
...
void ttZHistograms::SetValues(ttZ::leptonVariables leptonVars, ttZ::jetVariables jetVars, ttZ::reconstructedVariables reconstructedVars, ttZ::fourLeptonVariables fourLeptonVars) {
    ...
    topLeptonPt->SetValue(IN_RANGE(fourLeptonVars.topLeptonPt, BINS_topLeptonPt[0], BINS_topLeptonPt[NBINS_topLeptonPt]));
    topLeptonsMass->SetValue(IN_RANGE(fourLeptonVars.topLeptonsMass, BINS_topLeptonsMass[0], BINS_topLeptonsMass[NBINS_topLeptonsMass]));
    fourLeptonsMass->SetValue(IN_RANGE(fourLeptonVars.fourLeptonsMass, BINS_fourLeptonsMass[0], BINS_fourLeptonsMass[NBINS_fourLeptonsMass]));
...
void ttZHistograms::SetTruthValues(ttZ::ttzTruth truthVars) {
    ...
    ((MyTruthHistogram*)topLeptonPt)->SetTruthValue(IN_RANGE(truthVars.topLeptonPt, BINS_topLeptonPt[0], BINS_topLeptonPt[NBINS_topLeptonPt]));
    ((MyTruthHistogram*)topLeptonsMass)->SetTruthValue(IN_RANGE(truthVars.topLeptonsMass, BINS_topLeptonsMass[0], BINS_topLeptonsMass[NBINS_topLeptonsMass]));
    ((MyTruthHistogram*)fourLeptonsMass)->SetTruthValue(IN_RANGE(truthVars.fourLeptonsMass, BINS_fourLeptonsMass[0], BINS_fourLeptonsMass[NBINS_fourLeptonsMass]));
